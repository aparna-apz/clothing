...
SECRET_KEY = "django-insecure-0)2u5#o8_&w6z6n%e0x5wu20%ha)96v_kf#ga_g^_b35m_p+&7"
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=1),  # ✅ Access token valid for 7 days
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": "your-secret-key",  # Replace with `SECRET_KEY` from settings
